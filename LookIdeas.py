...
# Form implementation generated from reading ui file 'C:\Users\musta\Desktop\yenisayfalar\LookIdeas.ui'
#
...
class Ui_Dialog(object):
    def load(self):
        ...
        query = 'SELECT NameSurname, Idea FROM Ideas'
    ...
    def delete(self):
        ...
        for row in enumerate(alldata):
            if row[0] == self.tableWidget.currentRow():
                ...
                Idea = data[2]
                cursor.execute(
                    ''' DELETE FROM Ideas WHERE NameSurname = ? AND Idea = ?''',
                    (NameSurname, Idea))
                dbase.commit()
                self.deletedMessage()
                self.load()
...
"")
        ...
        self.tableWidget.setGeometry(QtCore.QRect(31, 50, 381, 192))
        self.tableWidget.setStyleSheet("border: 2px solid black")
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(5)
        self.tableWidget.setRowCount(5)
        self.closeButton = QtWidgets.QPushButton(Dialog)
        self.closeButton.setGeometry(QtCore.QRect(60, 280, 321, 21))
        font = QtGui.QFont()
        ...
        self.deleteButton.setGeometry(QtCore.QRect(60, 250, 321, 21))
        font = QtGui.QFont()
        font.setFamily("Georgia")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.GetTicketTitle.setText(_translate("Dialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600;\">Ideas</span></p></body></html>"))
