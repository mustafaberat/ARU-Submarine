...
"")
        ...
        self.GetTicketTitle.setGeometry(QtCore.QRect(36, 16, 321, 16))
        self.GetTicketTitle.setObjectName("GetTicketTitle")
        self.closeButton = QtWidgets.QPushButton(Dialog)
        self.closeButton.setGeometry(QtCore.QRect(40, 250, 321, 21))
        font = QtGui.QFont()
        ...
        self.GetTicketLine.setGeometry(QtCore.QRect(36, 30, 321, 16))
